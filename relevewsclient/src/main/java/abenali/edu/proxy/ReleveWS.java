 ...
 * 
 */
@WebServiceClient(name = "ReleveWS", targetNamespace = "http://webservice.edu.abenali/", wsdlLocation = "http://localhost:9191/?wsdl")
    ...
    extends Service
{
    ...
    private final static QName RELEVEWS_QNAME = new QName("http://webservice.edu.abenali/", "ReleveWS");
    ...
    public ReleveService getReleveServicePort() {
        return super.getPort(new QName("http://webservice.edu.abenali/", "ReleveServicePort"), ReleveService.class);
    }
    ...
    public ReleveService getReleveServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.edu.abenali/", "ReleveServicePort"), ReleveService.class, features);
    }

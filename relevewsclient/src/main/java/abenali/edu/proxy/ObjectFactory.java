 ...
 * generated in the abenali.edu.proxy package. 
...
public class ObjectFactory {
    ...
    private final static QName _JAXBException_QNAME = new QName("http://webservice.edu.abenali/", "JAXBException");
    private final static QName _GetReleve_QNAME = new QName("http://webservice.edu.abenali/", "getReleve");
    private final static QName _GetReleveResponse_QNAME = new QName("http://webservice.edu.abenali/", "getReleveResponse");
    private final static QName _Releve_QNAME = new QName("http://webservice.edu.abenali/", "releve");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: abenali.edu.proxy
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://webservice.edu.abenali/", name = "JAXBException")
     ...
     */
    @XmlElementDecl(namespace = "http://webservice.edu.abenali/", name = "getReleve")
     ...
     */
    @XmlElementDecl(namespace = "http://webservice.edu.abenali/", name = "getReleveResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://webservice.edu.abenali/", name = "releve")
